...
{
  "$end", "error", "$undefined", "HELLO", "GOODBYE", "TIME", "TETRIS",
  "ANIMATION", "CUBE", "COFFIN", "DIAMONDS", "YES", "NO", "$accept",
  "chatbot", "greeting", "farewell", "query", "tetris", "animation",
  "response", "yes", "no", "cube", "coffin", "diamonds", YY_NULLPTR
};
#endif
...
{
       0,     8,     9,    10,    11,    12,    20,    21,    22,    18,
      19,     0,     2,     3,     4,     5,     6,     7,    13,    14,
      15,    16,    17,     1
};
